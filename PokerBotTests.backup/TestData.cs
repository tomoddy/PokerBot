...
namespace PokerBot.Tests
{
    ...
    class HandData
    {
        public static IEnumerable RankingData
        {
            get
            {
                yield return new TestCaseData(GetPlayer(Suit.Clubs, Rank.Ace, Suit.Clubs, Rank.King), GetTable(Suit.Clubs, Rank.Queen, Suit.Clubs, Rank.Jack, Suit.Clubs, Rank.Ten, Suit.Hearts, Rank.Two, Suit.Hearts, Rank.Three)).Returns(Strength.RoyalFlush);
                yield return new TestCaseData(GetPlayer(Suit.Diamonds, Rank.Nine, Suit.Diamonds, Rank.Eight), GetTable(Suit.Diamonds, Rank.Seven, Suit.Diamonds, Rank.Six, Suit.Diamonds, Rank.Five, Suit.Hearts, Rank.Two, Suit.Hearts, Rank.Three)).Returns(Strength.StraightFlush);
                yield return new TestCaseData(GetPlayer(Suit.Clubs, Rank.Ace, Suit.Diamonds, Rank.Ace), GetTable(Suit.Hearts, Rank.Ace, Suit.Spades, Rank.Ace, Suit.Hearts, Rank.Two, Suit.Hearts, Rank.Three, Suit.Hearts, Rank.Four)).Returns(Strength.FourOfAKind);
                yield return new TestCaseData(GetPlayer(Suit.Clubs, Rank.Queen, Suit.Diamonds, Rank.Queen), GetTable(Suit.Hearts, Rank.Queen, Suit.Spades, Rank.Jack, Suit.Hearts, Rank.Jack, Suit.Hearts, Rank.Three, Suit.Hearts, Rank.Four)).Returns(Strength.FullHouse);
                yield return new TestCaseData(GetPlayer(Suit.Hearts, Rank.Ace, Suit.Hearts, Rank.Jack), GetTable(Suit.Hearts, Rank.Nine, Suit.Hearts, Rank.Six, Suit.Hearts, Rank.Three, Suit.Clubs, Rank.Two, Suit.Clubs, Rank.Three)).Returns(Strength.Flush);
                yield return new TestCaseData(GetPlayer(Suit.Clubs, Rank.Nine, Suit.Diamonds, Rank.Eight), GetTable(Suit.Spades, Rank.Seven, Suit.Diamonds, Rank.Six, Suit.Spades, Rank.Five, Suit.Hearts, Rank.Two, Suit.Hearts, Rank.Three)).Returns(Strength.Straight);
                yield return new TestCaseData(GetPlayer(Suit.Hearts, Rank.Two, Suit.Spades, Rank.Two), GetTable(Suit.Diamonds, Rank.Two, Suit.Clubs, Rank.Ace, Suit.Diamonds, Rank.King, Suit.Hearts, Rank.Queen, Suit.Spades, Rank.Jack)).Returns(Strength.ThreeOfAKind);
                yield return new TestCaseData(GetPlayer(Suit.Hearts, Rank.Ace, Suit.Clubs, Rank.Ace), GetTable(Suit.Hearts, Rank.King, Suit.Spades, Rank.King, Suit.Hearts, Rank.Two, Suit.Clubs, Rank.Three, Suit.Diamonds, Rank.Four)).Returns(Strength.TwoPair);
                yield return new TestCaseData(GetPlayer(Suit.Hearts, Rank.King, Suit.Clubs, Rank.Ace), GetTable(Suit.Hearts, Rank.King, Suit.Spades, Rank.Queen, Suit.Hearts, Rank.Two, Suit.Clubs, Rank.Three, Suit.Diamonds, Rank.Four)).Returns(Strength.Pair);
                yield return new TestCaseData(GetPlayer(Suit.Hearts, Rank.Ace, Suit.Clubs, Rank.Five), GetTable(Suit.Hearts, Rank.Jack, Suit.Spades, Rank.King, Suit.Hearts, Rank.Two, Suit.Clubs, Rank.Three, Suit.Diamonds, Rank.Four)).Returns(Strength.HighCard);
            }
        }
